...
import com.ecloth.beta.member.jwt.*;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] PERMIT_URL_ARRAY = {
            ...
            "/h2-console/**",
            //swagger
            "/swagger-ui.html", "/swagger-ui/index.html", "/swagger/**", "/swagger-resources/**", "/v2/api-docs", "/webjars/**",
            // api
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .anyRequest().authenticated(); //회원가입,이메일인증,로그인,토큰재발급을 제외한 모든 API 인증필요
